                ...
                <div key={item.id} className="bg-card rounded-2xl p-4 md:p-6 shadow-soft border border-border">
                  <div className="flex flex-col sm:flex-row gap-4 md:gap-6">
                    <img
                      ...
                      loading="lazy"
                      decoding="async"
                      className="w-full sm:w-24 h-48 sm:h-24 object-contain p-2 rounded-xl bg-white border border-border"
                    />
            ...
            <div className="lg:col-span-1">
              <div className="bg-card rounded-2xl p-8 shadow-luxury border border-border sticky top-24">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between text-muted-foreground">
                    <span>Shipping</span>
                    <span className="font-semibold text-right max-w-[120px]">Calculated at checkout</span>
                  </div>
